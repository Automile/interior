      ...
      return _react2['default'].createElement(
        ...
        showMonthArrow ? _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'svg',
            { className: 'shape', 'aria-hidden': 'true' },
            _react2['default'].createElement('use', { xlinkHref: '#shape-caret-left' })
          )
        ) : null,
        _react2['default'].createElement(
          'span',
        ...
        showMonthArrow ? _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'svg',
            { className: 'shape', 'aria-hidden': 'true' },
            _react2['default'].createElement('use', { xlinkHref: '#shape-caret-right' })
          )
        ) : null
      );
    }
...
/*<i style={onlyClasses ? undefined : { ...styles['MonthArrow'], ...styles['MonthArrowPrev'] }}></i>*/ /*<i style={onlyClasses ? undefined : { ...styles['MonthArrow'], ...styles['MonthArrowNext'] }}></i>*/